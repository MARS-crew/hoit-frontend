        ...
        case '현황':
          return (
            <div className="w-full h-full">
              <h2 className="text-lg font-semibold pt-4 pl-4">프로젝트 현황</h2>
              {recommendedUsers.map((user, index) => (
                ...
                >
                  ...
                  <div className="w-full h-full p-4">
                    ...
                    >
                      {/* 설명 */}
                      <p className="text-gray-700 mb-4 font-bold">{user.sendRequest}</p>
                      
                      {/* 프로필 정보 */}
                      <div className="flex items-center gap-2 mb-4 pb-4">
                        <span className="font-medium text-xl">{user.name}</span>
                        <span className="text-gray-500">끊임없이! 매일 1% 성장하는 개발자! 이고 싶다.</span>
                        <div className="flex gap-2 mb-4 pb-4">
                      </div>
                      </div>

                      <p className="text-gray-700 mb-4 font-bold">{user.recieveRequest}</p>
                      ...
                      <p className="text-gray-700 mb-4 font-bold pt-40">{user.participantsList}</p>
                      <div className="flex items-center gap-2 mb-4 pb-4">
                        <span className="font-medium text-xl">{user.name}</span>
                        <span className="text-gray-500">끊임없이! 매일 1% 성장하는 개발자! 이고 싶다.</span>
                        <div className="flex gap-2 mb-4 pb-4">
